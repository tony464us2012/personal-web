    ...
    return (
        <article className='w-full flex items-center justify-between relative
         rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12'>
            ...
            <div className='w-1/2 flex flex-col item-start justify-between pl-6'>
                <span className='text-primary font-medium text-xl'>
                    {type}
                </span>
                <Link href={link} target='_blank' className='hover:underline underline-offset-2'>
                    <h2 className='my-2 w-full text-left text-4xl fon-bold'>{title}</h2>
                </Link>
        ...
        border border-solid border-dark bg-light p-6 relative'>
           ...
           <div className='w-full flex flex-col item-start justify-between mt-4'>
               ...
               <Link href={link} 
                   ...
                   <h2 className='my-2 w-full text-left text-3xl fon-bold'>{title}</h2>
               </Link>
